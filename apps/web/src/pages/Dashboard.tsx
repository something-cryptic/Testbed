    ...
    <div className="min-h-screen bg-[#0f0d1a]">
      ...
      <main className="relative max-w-3xl mx-auto px-4 py-8 flex flex-col gap-6">
        ...
        <section className="flex flex-col gap-4">
          <h2 className="text-xs font-semibold text-violet-400/60 uppercase tracking-widest">Connected Platforms</h2>
          ...
          {profile && !profile.connectedPlatforms.find((p) => p.platform === 'instagram') && (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-violet-900/30 border border-violet-700/30 flex items-center justify-center">
                <svg className="w-6 h-6 text-violet-500/50 group-hover:text-violet-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div>
                <p className="font-medium text-violet-300/60 group-hover:text-violet-200 transition-colors">+ Connect Instagram</p>
                <p className="text-sm text-violet-500/40 mt-0.5">Add your account to unlock cross-platform insights</p>
              </div>
            </a>
          )}
        </section>
        ...
        {isMultiPlatform && (
          <section className="bg-gradient-to-br from-violet-900/25 to-fuchsia-900/20 border border-violet-700/30 rounded-2xl p-6 flex flex-col gap-4">
            ...
            {lastHolisticStr && (
              <div className="flex items-center gap-3 text-sm text-violet-400/50">
